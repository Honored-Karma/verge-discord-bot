...
- **2025-11-22 (v2)**: Система предметов и глобальные улучшения
  - Упрощена система выдачи предметов - по названию вместо ID
...
## Система предметов
- Админы выдают предметы через `/give-item` по **названию** предмета, не по ID
- Предметы используются командой `/use`
- Текущие доступные предметы:
  - AP Tome (50) - +50 AP
  - AP Tome (100) - +100 AP
  - SP Scroll: Muay Thai - +30 SP в Муай Тай
  - SP Scroll: Aikido - +30 SP в Айкидо
